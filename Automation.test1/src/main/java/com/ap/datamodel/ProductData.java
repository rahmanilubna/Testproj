...
public class ProductData {
	...
	@Override
	public int hashCode() {
		final int prime = 31;//limit set
		int result = 1;//default starter on website
		//hashcode: when it invokes on the same object more than once during execution
		//it should consistently return the same value without foreign value/object
		//do not give decimal values as return
		result = prime * result + ((color == null) ? 0 : color.hashCode());
		//if there is no information(empty) dont do the multiplication
